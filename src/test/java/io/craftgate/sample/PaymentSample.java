...
public class PaymentSample {
    ...
    @Test
    void init_tokenflex_apm_payment() {
        List<PaymentItem> items = new ArrayList<>();
    ...
    @Test
    void complete_tokenflex_apm_payment() {
        CompleteApmPaymentRequest request = CompleteApmPaymentRequest.builder()
                .paymentId(1L)
                .additionalParams(new HashMap<String, String>() {{
                    put("otpCode", "784294");
    ...
    @Test
    void init_tokenflex_gift_apm_payment() {
        List<PaymentItem> items = new ArrayList<>();
    ...
    @Test
    void complete_tokenflex_gift_apm_payment() {
        CompleteApmPaymentRequest request = CompleteApmPaymentRequest.builder()
                .paymentId(1L)
                .additionalParams(new HashMap<String, String>() {{
                    put("otpCode", "784294");
