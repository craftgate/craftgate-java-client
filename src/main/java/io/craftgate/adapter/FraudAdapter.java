...
public class FraudAdapter extends BaseAdapter {
    ...
    private FraudAdapter(RequestOptions requestOptions, RequestContext requestContext) {
        super(requestOptions, requestContext);
    }

    public FraudAdapter withRequestContext(RequestContext requestContext) {
        return new FraudAdapter(requestOptions, requestContext);
    }
