...
public class MasterpassPaymentAdapter extends BaseAdapter {
    ...
    private MasterpassPaymentAdapter(RequestOptions requestOptions, RequestContext requestContext) {
        super(requestOptions, requestContext);
    }

    public MasterpassPaymentAdapter withRequestContext(RequestContext requestContext) {
        return new MasterpassPaymentAdapter(requestOptions, requestContext);
    }
