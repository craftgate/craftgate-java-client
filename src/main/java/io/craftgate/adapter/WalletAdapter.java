...
public class WalletAdapter extends BaseAdapter {
    ...
    private WalletAdapter(RequestOptions requestOptions, RequestContext requestContext) {
        super(requestOptions, requestContext);
    }

    public WalletAdapter withRequestContext(RequestContext requestContext) {
        return new WalletAdapter(requestOptions, requestContext);
    }
    ...
    public WalletResponse updateWallet(Long memberId, Long walletId, UpdateWalletRequest request) {
        ...
        return HttpClient.put(requestOptions.getBaseUrl() + path, createHeaders(request, path, requestOptions), request, WalletResponse.class);
    }
