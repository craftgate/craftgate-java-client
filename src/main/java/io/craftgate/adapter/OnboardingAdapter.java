...
public class OnboardingAdapter extends BaseAdapter {
    ...
    private OnboardingAdapter(RequestOptions requestOptions, RequestContext requestContext) {
        super(requestOptions, requestContext);
    }

    public OnboardingAdapter withRequestContext(RequestContext requestContext) {
        return new OnboardingAdapter(requestOptions, requestContext);
    }
