...
public abstract class BaseAdapter {
    ...
    protected BaseAdapter(RequestOptions requestOptions, RequestContext requestContext) {
    ...
    private Map<String, String> createHttpHeaders(Object request, String path, RequestOptions options) {
        ...
        if (Objects.nonNull(requestContext) && Objects.nonNull(requestContext.getIdempotencyKey())) {
            headers.put(IDEMPOTENCY_KEY_HEADER_NAME, requestContext.getIdempotencyKey());
        }
        return headers;
    }
